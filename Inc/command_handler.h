...
#define COMMAND_START_SAMPLING        (0xF3)
#define COMMAND_STOP_SAMPLING         (0xF4)
#define COMMAND_SET_SAMPLING_INTERVAL (0xF5)
...
#define COMMAND_START_SAMPLING_PAYLOAD_SIZE   (0)
#define COMMAND_STOP_SAMPLING_PAYLOAD_SIZE    (0)
#define COMMAND_SET_SAMPLING_INTERVAL_PAYLOAD_SIZE   (1)
